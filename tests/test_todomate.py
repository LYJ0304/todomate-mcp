...
class Firestore:
    def __init__(self):
        self.documents = {
            "TodoItem/one": {"id": "one", "writerID": "user", "content": "first", "createTime": 2},
            "TodoItem/two": {"id": "two", "writerID": "user", "content": "second", "createTime": 1},
...
def test_todo_crud_maps_fields_validates_ownership_and_sorts_list():
    async def run():
        ...
        assert done["isDone"] is True and isinstance(done["doneTime"], int)
